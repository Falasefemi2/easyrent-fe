...
export default function EmptyState({
	...
	const config = {
		listings: {
			...
			description:
				"Start by listing your first property and reach thousands of potential tenants.",
			color: "bg-orange-50",
		},
		favorites: {
			emoji: "🤍",
	...
	return (
		<div className="flex flex-col items-center justify-center py-16 px-4 text-center">
			<div
				className={`w-24 h-24 ${color} rounded-full flex items-center justify-center mb-6`}
			>
