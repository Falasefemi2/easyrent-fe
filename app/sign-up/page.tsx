      ...
      <div className="min-h-screen bg-white flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center px-4">
          <div className="w-full max-w-sm text-center space-y-4">
            ...
            <Link href="/sign-in" className="text-sm text-[#E8442A] hover:underline block">
      ...
      <div className="flex-1 flex items-center justify-center px-4 py-8">
        <Card className="w-full max-w-sm">
          <CardHeader>
            ...
            <CardDescription>Join EasyRent and find your next home</CardDescription>
          </CardHeader>
          <CardContent>
            ...
            <p className="text-center text-sm text-gray-500 mt-6">
              ...
              <Link href="/sign-in" className="text-[#E8442A] font-medium hover:underline">
                Sign in
              </Link>
            </p>
          </CardContent>
