...
export class ListingWithMedia extends Schema.Class<ListingWithMedia>("ListingWithMedia")({
  id: Schema.String,
  landlordId: Schema.String,
  title: Schema.String,
  description: Schema.String,
...
export class PaginatedListings extends Schema.Class<PaginatedListings>("PaginatedListings")({
...
export class FavoriteListing extends Schema.Class<FavoriteListing>("FavoriteListing")({
  id: Schema.String,
  landlordId: Schema.String,
  title: Schema.String,
  description: Schema.String,
...
export class PaginatedFavorites extends Schema.Class<PaginatedFavorites>("PaginatedFavorites")({
...
export class AuthError extends Schema.TaggedErrorClass<AuthError>()("AuthError", { message: Schema.String }) {}
